  ...
  plugins: [
    ...
    prerenderStatic({
      routes: [
        ...
        { path: '/aboutUs', tags: { title: 'О нас | FoxPrint', description: 'Собственное производство во Владивостоке: широкоформатная печать, вывески, брендирование авто, оформление магазинов. Работаем с 2018 года. Закажите расчёт!', canonical: 'https://xn--h1adkbggfmk.xn--p1ai/aboutUs', robots: 'index, follow' } },
